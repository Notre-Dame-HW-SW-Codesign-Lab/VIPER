...
define dso_local void @top(i64 noundef %0, i64 noundef %1, i64 noundef %2) local_unnamed_addr #0 {
  ...
  store volatile i32 512, ptr inttoptr (i32 788529169 to ptr), align 4, !tbaa !8
...
8:                                                ; preds = %4
  ...
  store volatile i64 788529920, ptr inttoptr (i32 788529161 to ptr), align 8, !tbaa !4
  store volatile i32 512, ptr inttoptr (i32 788529169 to ptr), align 4, !tbaa !8
  store volatile i8 1, ptr inttoptr (i32 788529152 to ptr), align 16777216, !tbaa !10
  br label %9
...
18:                                               ; preds = %14
  store volatile i64 788530496, ptr inttoptr (i32 788529153 to ptr), align 8, !tbaa !4
