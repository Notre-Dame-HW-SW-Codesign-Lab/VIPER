...
fill_cache:
    ...
    /* Override 0x80C00000 to be Normal Non-Cacheable memory so that
     * the NonCoherentDMA can read CPU writes and CPU can read DMA results
    ...
    str r2, [r0, r4, lsl #2]    @ Overwrite just this one 1MB entry
